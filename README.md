...
I rebuilt my [NHS Policy Assistant](../README.md) — originally a pro-code RAG application using Azure OpenAI, Azure AI Search, and Streamlit — as a **low-code agent in Microsoft Copilot Studio**, deployed to **Microsoft Teams**.
